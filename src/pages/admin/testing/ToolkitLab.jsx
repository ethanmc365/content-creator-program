...
Tag @Maya Okonjo if you want a second pair of eyes, and put the link here:
          ...
          <div>
            ...
            <div className="min-h-[14rem] rounded-card border border-gray-100 bg-white p-5">
              <div className="flex items-start gap-3">
                <span className="flex h-9 w-9 shrink-0 items-center justify-center rounded-full bg-brand-tint text-xs font-semibold text-brand">MO</span>
                <div className="min-w-0 flex-1">
                  <p className="flex items-baseline gap-2">
                    <span className="text-sm font-semibold">Maya Okonjo</span>
