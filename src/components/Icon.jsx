...
const PATHS = {
  ...
  // TWO ARROWS ROUND A CIRCLE - "read it again". Drawn for the video tracker's
  // "Sync from entries", which had been reaching for `download` (that is a file
  // arriving, not a figure being refreshed). The arcs stop short of each other
  // and the heads sit in the gaps, which is what stops it reading as a solid
  // ring at 16px.
  refresh: 'M4.5 12a7.5 7.5 0 0 1 12.9-5.2M19.5 12a7.5 7.5 0 0 1-12.9 5.2M17.4 3.4v3.4H14M6.6 20.6v-3.4H10',
