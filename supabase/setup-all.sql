-- ============================================================
-- Tryp.com Creator Platform — ONE-PASTE SETUP (schema + seed)
...
update public.profiles set created_at = now() - interval '150 days', onboarded = true, is_admin = true,
  ...
  about = 'I started the Tryp.com Content Creator Program to build a real community of travel creators across the UK & Ireland. Message me any time — my door is always open.',
